...
I'm a software engineer with 6+ years of experience building scalable web applications, distributed systems, and cloud-native platforms.

My primary focus is designing high-performance backend systems, microservices, and AI-powered applications that solve real business problems. I enjoy building products that are reliable, maintainable, and easy to scale.

### Highlights

- 🚀 Built scalable SaaS applications using Ruby on Rails, Python, Node.js, and TypeScript
- ⚡ Improved backend processing performance by **40%**
...
![RSpec](https://img.shields.io/badge/RSpec-7D4698?style=flat-square)
